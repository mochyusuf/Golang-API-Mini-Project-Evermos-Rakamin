...
func PrivateRoutes(UserHandler *handler.UserHandler, AlamatHandler *handler.AlamatHandler, TokoHandler *handler.TokoHandler, CategoryHandler *handler.CategoryHandler, ProdukHandler *handler.ProdukHandler, TrxHandler *handler.TrxHandler) []*Route {	return []*Route{
